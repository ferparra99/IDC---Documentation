...
| `horasOrdinariasPorDia` | Umbral de horas ordinarias por jornada, usado por el motor de cálculo para detectar horas extra dentro de un mismo turno | 8 |
...
1. **Fase 1 — Base:** modelo de datos, autenticación, variables de sistema, módulo de fichaje (5.1). **✅ Completada** — ver `timetracker-backend/`.
